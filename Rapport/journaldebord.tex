...
\begin{document}
	...
	\subsection{Objectifs de la séance prochaine}
	\begin{todolist}
		\item Trouver une idée de quoi en faire maintenant qu'on sait que le poids de Hamming fuit bien
		\item Relire à tête reposée l'attaque DPA, une dernière fois
	\end{todolist}

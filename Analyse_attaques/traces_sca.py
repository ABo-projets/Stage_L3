...
np.save("Mesures/traces.npy", nptraces)

nppts = np.asarray(pts)
np.save("Mesures/pts.npy", nppts)

npcts = np.asarray(cts)
np.save("Mesures/cts.npy", npcts)

npnonces = np.asarray([nonces])
np.save("Mesures/nonces.npy", npnonces)

nptags = np.asarray(tags)
np.save("Mesures/tags.npy", nptags)

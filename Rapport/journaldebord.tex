...
\begin{document}
	...
	\begin{todolist}
		...
		\item Si temps supplémentaire : refaire légende du graphe normalisé, faire la s-Box en Tikz, refaire le Tikz du déchiffrement pour être cohérent sur le code couleur
	\end{todolist}
	...
	\begin{todolist}
		...
		\item Passer et se chronométrer
		\item Regarder combien d'erreur le tag d'Ascon remarque
		\item Envoyer présentation par mail pour jeudi
		\item Enoyer tout à Hélène pour qu'elle puisse relire
	\end{todolist}

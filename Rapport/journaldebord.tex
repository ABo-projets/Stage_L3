...
\begin{document}
	...
	\begin{todolist}
		...
		\item Trouver des idées de raison pour laquelle la clé fuite mal
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.8]{HWvrai_vs_HWalea}
	...
	\begin{todolist}
		...
		\item Répondre au mail pour la présentation
	\end{todolist}
	...
	\begin{todolist}
		...
		\item Répondre au mail
		\item Corriger la présentation
		\item Réfléchir à pourquoi la fausse clé donne une bonne corrélation : la s-box devrait disperser
	\end{todolist}
	
	
	\section{Questions pour l'entretien hebdomadaire}
	\begin{itemize}
		\item Comment ça se fait que pour des faux HW, on est une IM négligeable, mais que pour des fausses clés, supposées donc donner des HW aléatoires par hypothèse crypto, on ait une corrélation ?
	\end{itemize}
